...
message_types = {'positive': 'success', 'neutral': 'info', 'negative': 'error'}
...
if st.button('Analyze'):
    if not is_valid_input(input_text):
        ...
        # Show a message type based on the sentiment
        st.write('Result:')
        st.write({message_types[prediction]: f'The text is {prediction.capitalize()}.'})
